...
puncture during dialysis sessions. This can be done either in a one stage or two stage procedure. In a 2-stage
procedure, the direct arteriovenous anastomosis is
...
Many surgeons will do a brachiobasiic arteriovenous fistula creation with the transposition in one stage. However, if the vein is \<4mm, then it is generally recommended to do a 2-stage procedure so that if the fistula does not mature, the patient does not have to undergo a second stage operation with extensive dissection of the vein. When a patient has not been initiated on
