...
puncture during dialysis sessions. Transpositions can be done in one or two
stages. In a 2-stage procedure, the direct arteriovenous anastomosis is
...
Many surgeons will do a one stage procedure with the creation of a brachiobasilic arteriovenous fistula and a transposition. However, if the vein is <4mm then generally a second stage operation is recommended. When a patient has not been initiated on
